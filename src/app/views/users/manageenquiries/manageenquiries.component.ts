...
import { ManagenquiriespopupComponent } from './managenquiriespopup/managenquiriespopup.component';
...
export class ManageenquiriesComponent implements OnInit {
  ...
  getItems() {
    ...
    this.getItemSub = this.service.getAllEnquiries()
      .subscribe(data => {
  ...
  openPopUp(data: any = {}, isNew?,_id:any="") {
    ...
    let title = isNew ? 'Add New Enquiry' : 'Update Enquiry';
    let dialogRef: MatDialogRef<any> = this.dialog.open(ManagenquiriespopupComponent, {
      width: '720px',
      disableClose: true,
