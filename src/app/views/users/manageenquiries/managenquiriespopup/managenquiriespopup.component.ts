...
@Component({
  selector: 'app-managenquiriespopup',
  templateUrl: './managenquiriespopup.component.html',
  styleUrls: ['./managenquiriespopup.component.scss']
})
export class ManagenquiriespopupComponent implements OnInit {
...
uploadedFilePath: string = null;
  constructor(
    ...
    public dialogRef: MatDialogRef<ManagenquiriespopupComponent>,
...
reader.onload = (_event) => { 
  ...
  buildItemForm(item) {
    ...
    this.itemForm = this.fb.group({
      ...
      productEnquired: [item.productEnquired || ''],
      phonenumber:[item.password || ''],
      date: [item.date || ''],
      email: [item.email || ''],
